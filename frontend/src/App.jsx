...
function App() {
  ...
  return (
    <div className="container">
      ...
      <nav>
        <a
          className="foresights"
          href="https://foresights.ca"
          target="_blank"
          rel="noreferrer"
        >
      ...
      {isPopupVisible && (
        <div className="popup visible">
          ...
          <hr />
          <a
            href="https://www.linkedin.com/in/isaiahiruoha/"
            target="_blank"
            rel="noreferrer"
          >
            Isaiah Iruoha
          ...
          <a
            href="https://www.linkedin.com/in/connorleung/"
            target="_blank"
            rel="noreferrer"
          >
            Connor Leung
          ...
          <a
            href="https://www.linkedin.com/in/ryan-z-su/"
            target="_blank"
            rel="noreferrer"
          >
            Ryan Su
      ...
      <div className="coach-container" onClick={toggleCoachPopup}>
        ...
        {/* Lightbulb icon */}
        <i
          className={`fas fa-lightbulb coach-lightbulb ${
            isCoachPopupVisible ? "hidden" : ""
          }`}
        ></i>
        ...
        {isCoachPopupVisible && (
          <div className="popup coach-popup visible">
            ...
            <hr />
            <p>
              "Consistency is key—every swing builds your mastery. Focus on your
              form today, and tomorrow's power will follow!"
            </p>
          </div>
        )}
      </div>
