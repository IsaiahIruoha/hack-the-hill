...
function App() {
  ...
  const [clubData, setClubData] = useState({
    speed: null, // Initialize with null to represent no data
    launch_angle: null,
  });
      ...
      <div className="coach-container" onClick={toggleCoachPopup}>
        ...
        {isCoachPopupVisible && (
          <div className="popup coach-popup visible">
            ...
            <hr />
            <p>
              "Consistency is key—every swing builds your mastery. Focus on your form today, and
              tomorrow's power will follow!"
            </p>
          </div>
        )}
      </div>
